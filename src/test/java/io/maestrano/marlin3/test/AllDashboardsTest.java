...
public class AllDashboardsTest extends BaseTest {
	String testName = "AllDashboardsTest";

	@Test(dataProvider = "getData")
	public void allDashboardsTest(Hashtable<String, String> data) throws Exception {
		...
		exeDashboardPage.displayAllDashboards();
		Thread.sleep(5000);
		exeDashboardPage.displayAllKPIs();
