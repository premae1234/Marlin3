...
public class AllKPIsOnDashboardTest extends BaseTest {
	String testName = "AllKPIsOnDashboardTest";

	@Test(dataProvider = "getData")
	public void allKPIsOnDashboardTest(Hashtable<String, String> data) throws Exception {
